 ...
 */var z=V,B=Symbol.for("react.element"),$=Symbol.for("react.fragment"),q=Object.prototype.hasOwnProperty,H=z.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,K={key:!0,ref:!0,__self:!0,__source:!0};function G(e,t,n){var r,i={},s=null,a=null;for(r in void 0!==n&&(s=""+n),void 0!==t.key&&(s=""+t.key),void 0!==t.ref&&(a=t.ref),t)q.call(t,r)&&!K.hasOwnProperty(r)&&(i[r]=t[r]);if(e&&e.defaultProps)for(r in t=e.defaultProps)void 0===i[r]&&(i[r]=t[r]);return{$$typeof:B,type:e,key:s,ref:a,props:i,_owner:H.current}}n.Fragment=$,n.jsx=G,n.jsxs=G,t.exports=n;var W=t.exports,Q={},X={exports:{}},Y={},J={exports:{}},Z={};
/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qf(e){var t;const n=e.auth,r=await e.getIdToken(),i=await zf(e,Mf(n,{idToken:r}));yf(null==i?void 0:i.users.length,n,"internal-error");const s=i.users[0];e._notifyReloadListener(s);const a=(null===(t=s.providerUserInfo)||void 0===t?void 0:t.length)?Hf(s.providerUserInfo):[],o=(l=e.providerData,u=a,[...l.filter((e=>!u.some((t=>t.providerId===e.providerId)))),...u]);var l,u;const c=e.isAnonymous,h=!(e.email&&s.passwordHash||(null==o?void 0:o.length)),d=!!c&&h,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:o,metadata:new $f(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(e,f)}function Hf(e){return e.map((e=>{var{providerId:t}=e,n=af(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}}))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dp(e,t=[]){let n;switch(e){case"Browser":n=tp(bh());break;case"Worker":n=`${tp(bh())}-${e}`;break;default:n=e}const r=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${Hd}/${r}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
function Kp(){return void 0!==Hp().WorkerGlobalScope&&"function"==typeof Hp().importScripts}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Em=new Sf(3e4,6e4);function Sm(){const e=Hp().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let n=0;n<e.CP.length;n++)e.CP[n]=null}function km(e){return new Promise(((t,n)=>{var r,i,s,a;function o(){Sm(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Sm(),n(ff(e,"network-request-failed"))},timeout:Em.get()})}if(null===(i=null===(r=Hp().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=Hp().gapi)||void 0===s?void 0:s.load)){const t=`__${"iframefcb"}${Math.floor(1e6*Math.random())}`;return Hp()[t]=()=>{gapi.load?o():n(ff(e,"network-request-failed"))},(a=`${vp.gapiScript}?onload=${t}`,vp.loadJS(a)).catch((e=>n(e)))}o()}})).catch((e=>{throw Tm=null,e}))}let Tm=null;
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const Cm=new Sf(5e3,15e3),Im={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},xm=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Nm(e){const t=e.config;yf(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?kf(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,r={apiKey:t.apiKey,appName:e.name,v:Hd},i=xm.get(e.config.apiHost);i&&(r.eid=i);const s=e._getFrameworks();return s.length&&(r.fw=s.join(",")),`${n}?${Ih(r).slice(1)}`}async function Am(e){const t=await function(e){return Tm=Tm||km(e),Tm}(e),n=Hp().gapi;return yf(n,e,"internal-error"),t.open({where:document.body,url:Nm(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Im,dontclear:!0},(t=>new Promise((async(n,r)=>{await t.restyle({setHideOnLeave:!1});const i=ff(e,"network-request-failed"),s=Hp().setTimeout((()=>{r(i)}),Cm.get());function a(){Hp().clearTimeout(s),n(t)}t.ping(a).then(a,(()=>{r(i)}))}))))}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const $m=fh("authIdTokenMaxAge")||300;let qm=null;function Hm(e=Gd()){const t=zd(e,"auth");if(t.isInitialized())return t.getImmediate();const n=
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gg{constructor(e){this.path=e}static fromPath(e){return new Gg(qg.fromString(e))}static fromName(e){return new Gg(qg.fromString(e).popFirst(5))}static empty(){return new Gg(qg.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===qg.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return qg.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new Gg(new qg(e.slice()))}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qb{constructor(){this.sessionToken=gy.EMPTY_BYTE_STRING}getSessionToken(e){return Zg.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,Zg.resolve()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hb{constructor(){this.$r=new dy(Kb.Ur),this.Kr=new dy(Kb.Wr)}isEmpty(){return this.$r.isEmpty()}addReference(e,t){const n=new Kb(e,t);this.$r=this.$r.add(n),this.Kr=this.Kr.add(n)}Gr(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.zr(new Kb(e,t))}jr(e,t){e.forEach((e=>this.removeReference(e,t)))}Hr(e){const t=new Gg(new qg([])),n=new Kb(t,e),r=new Kb(t,e+1),i=[];return this.Kr.forEachInRange([n,r],(e=>{this.zr(e),i.push(e.key)})),i}Jr(){this.$r.forEach((e=>this.zr(e)))}zr(e){this.$r=this.$r.delete(e),this.Kr=this.Kr.delete(e)}Yr(e){const t=new Gg(new qg([])),n=new Kb(t,e),r=new Kb(t,e+1);let i=Qv();return this.Kr.forEachInRange([n,r],(e=>{i=i.add(e.key)})),i}containsKey(e){const t=new Kb(e,0),n=this.$r.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class Kb{constructor(e,t){this.key=e,this.Zr=t}static Ur(e,t){return Gg.comparator(e.key,t.key)||Dg(e.Zr,t.Zr)}static Wr(e,t){return Dg(e.Zr,t.Zr)||Gg.comparator(e.key,t.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dk(e){e=vS(e,TS);const t=vS(e.firestore,DS);return function(e,t,n={}){const r=new _g;return e.asyncQueue.enqueueAndForget((async()=>function(e,t,n,r,i){const s=new sS({next:o=>{s.Cu(),t.enqueueAndForget((()=>bE(e,a)));const l=o.docs.has(n);!l&&o.fromCache?i.reject(new bg(wg.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new bg(wg.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new CE(Iv(n.path),s,{includeMetadataChanges:!0,La:!0});return wE(e,a)}(await hS(e),e.asyncQueue,t,n,r))),r.promise}(LS(t),e._key).then((n=>yk(t,e,n)))}class fk extends ak{constructor(e){super(),this.firestore=e}convertBytes(e){return new MS(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new TS(this.firestore,null,t)}}function pk(e,t,n){e=vS(e,TS);const r=vS(e.firestore,DS),i=function(e,t,n){let r;return r=e?n&&(n.merge||n.mergeFields)?e.toFirestore(t,n):e.toFirestore(t):t,r}(e.converter,t,n);return gk(r,[GS(KS(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,fw.none())])}function mk(e,...t){var n,r,i;e=Ah(e);let s={includeMetadataChanges:!1,source:"default"},a=0;"object"!=typeof t[a]||PS(t[a])||(s=t[a],a++);const o={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(PS(t[a])){const e=t[a];t[a]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[a+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[a+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let l,u,c;if(e instanceof TS)u=vS(e.firestore,DS),c=Iv(e._key.path),l={next:n=>{t[a]&&t[a](yk(u,e,n))},error:t[a+1],complete:t[a+2]};else{const n=vS(e,kS);u=vS(n.firestore,DS),c=n._query;const r=new fk(u);l={next:e=>{t[a]&&t[a](new ck(u,r,n,e))},error:t[a+1],complete:t[a+2]},function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new bg(wg.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query)}return function(e,t,n,r){const i=new sS(r),s=new CE(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>wE(await hS(e),s))),()=>{i.Cu(),e.asyncQueue.enqueueAndForget((async()=>bE(await hS(e),s)))}}(LS(u),c,o,l)}function gk(e,t){return function(e,t){const n=new _g;return e.asyncQueue.enqueueAndForget((async()=>VE(await function(e){return cS(e).then((e=>e.syncEngine))}(e),t,n))),n.promise}(LS(e),t)}function yk(e,t,n){const r=n.docs.get(t._key),i=new fk(e);return new lk(e,i,t._key,r,new ok(n.hasPendingWrites,n.fromCache),t.converter)}!function(e,t=!0){lg=Hd,jd(new Rh("firestore",((e,{instanceIdentifier:n,options:r})=>{const i=e.getProvider("app").getImmediate(),s=new DS(new Tg(e.getProvider("auth-internal")),new Ng(i,e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new bg(wg.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ay(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:t},r),s._setSettings(r),s}),"PUBLIC").setMultipleInstances(!0)),Wd(sg,ag,e),Wd(sg,ag,"esm2017")}();const vk="undefined"!=typeof __firebase_config?JSON.parse(__firebase_config):{apiKey:"AIzaSyCjVr5-UHNxaBkqsg-7iEnr5GOjhDHLx-Y",authDomain:"simuladorappsheet.firebaseapp.com",projectId:"simuladorappsheet",storageBucket:"simuladorappsheet.firebasestorage.app",messagingSenderId:"161061857473",appId:"1:161061857473:web:9ef4fa4a9a94d4f6c5cc40",measurementId:"G-FBRXGWVE09"},wk="undefined"!=typeof __app_id?__app_id:vk.projectId,bk=()=>{const[e,t]=V.useState(null),[n,r]=V.useState(null),[i,s]=V.useState(null),[a,o]=V.useState(!1),[l,u]=V.useState("admin@example.com"),[c,h]=V.useState("welcome"),[d,f]=V.useState(null),[p,m]=V.useState({name:"",email:"",role:"User",active:!0,accessibleApps:[]}),[g,y]=V.useState([]),[v,w]=V.useState(!0),[b,_]=V.useState(null),E=[{name:"SISTEMA CT",url:"https://www.appsheet.com/start/9f46034d-5c24-43c8-a637-ba8f7bc0700f"},{name:"FINANCEIRO",url:"https://www.appsheet.com/start/33488d1b-ec20-4396-ae74-5b9664a36b17"},{name:"PROFISSIONAIS",url:"https://www.appsheet.com/start/b2b10225-0562-48b7-b3ac-1d300d1ae4fe"},{name:"ENFERMARIA",url:"https://www.appsheet.com/start/eaee5a73-dfe7-4ff7-ae03-8b2928bb2ddc"},{name:"OCORRÊNCIAS",url:"https://www.appsheet.com/start/14ab4e7f-e828-4fd5-b963-cfb8db749644"},{name:"CANTINA",url:"https://www.appsheet.com/start/a37e669b-ecc5-49a3-b9c7-fd6dd31e55ad"},{name:"ESTOQUE",url:"https://www.appsheet.com/start/f3558652-c5b9-4756-bbd3-51f6a8dfac93"}];V.useEffect((()=>{try{const e=Kd(vk),n=Hm(e),i=OS(e);r(n),t(i);const a=function(e,t,n,r){return Ah(e).onAuthStateChanged(t,n,r)}(n,(async e=>{var t;if(e)s(e.uid);else try{await Dp(n),s((null==(t=n.currentUser)?void 0:t.uid)||crypto.randomUUID())}catch(r){console.error("Erro ao autenticar anonimamente:",r),_("Falha na autenticação. Por favor, verifique a configuração de autenticação anónima no Firebase.")}o(!0)}));return()=>a()}catch(e){console.error("Erro na inicialização do Firebase:",e),_("Erro crítico na inicialização do sistema. Verifique a configuração do Firebase."),w(!1)}}),[]),V.useEffect((()=>{if(!e||!a||!i)return;w(!0),_(null);const t=IS(e,`artifacts/${wk}/public/data/users`),n=mk(t,(e=>{const t=e.docs.map((e=>({id:e.id,...e.data()})));if(y(t),w(!1),t.length>0){const e=t.find((e=>"admin@example.com"===e.email));u(e?e.email:t[0].email)}else u("")}),(e=>{console.error("Erro ao carregar usuários do Firestore:",e.code,e.message),_(`Erro ao carregar usuários: ${e.message}. Verifique as permissões do Firestore e tente recarregar a página.`),w(!1)}));(async()=>{const e=xS(t,"admin-default");try{if(!(await dk(e)).exists()){const t={id:"admin-default",name:"Admin Padrão",email:"admin@example.com",role:"Admin",active:!0,accessibleApps:E.map((e=>e.name))};await pk(e,t)}}catch(n){console.error("Erro ao verificar/criar admin padrão:",n)}})();const r=setTimeout((()=>{v&&(console.warn("Timeout de carregamento de usuários atingido. Verifique dados ou permissões."),w(!1),b||_("O carregamento demorou muito. Verifique a conexão ou os dados."))}),15e3);return()=>{n(),clearTimeout(r)}}),[e,a,i,wk,E]),V.useEffect((()=>{m(d||{name:"",email:"",role:"User",active:!0,accessibleApps:[]})}),[c,d]);const S=async t=>{if(e){w(!0),_(null);try{const r=IS(e,`artifacts/${wk}/public/data/users`);await(n=xS(r,t),gk(vS(n.firestore,DS),[new Cw(n._key,fw.none())]))}catch(r){console.error("Erro ao deletar usuário do Firestore:",r),_("Erro ao deletar usuário. Tente novamente.")}finally{w(!1)}var n}else _("Base de dados não inicializada.")};return W.jsxs("div",{className:"w-full font-inter min-h-screen flex items-center justify-center py-10 bg-gradient-to-br from-blue-50 to-indigo-100",children:[W.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap",rel:"stylesheet"}),W.jsx("script",{src:"https://cdn.tailwindcss.com"}),W.jsx("style",{children:"\n                /* Animações CSS para um toque mais bonito */\n                @keyframes fade-in-down {\n                    from {\n                        opacity: 0;\n                        transform: translateY(-20px);\n                    }\n                    to {\n                        opacity: 1;\n                        transform: translateY(0);\n                    }\n                }\n                @keyframes fade-in {\n                    from {\n                        opacity: 0;\n                    }\n                    to {\n                        opacity: 1;\n                    }\n                }\n                @keyframes pulse {\n                    0%, 100% {\n                        opacity: 1;\n                    }\n                    50% {\n                        opacity: .5;\n                    }\n                }\n                .animate-fade-in-down {\n                    animation: fade-in-down 0.6s ease-out forwards;\n                }\n                .animate-fade-in {\n                    animation: fade-in 0.8s ease-out forwards;\n                }\n                .animate-pulse {\n                    animation: pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite;\n                }\n                "}),W.jsxs("div",{className:"max-w-7xl w-full mx-auto bg-white rounded-3xl shadow-2xl p-10 border border-gray-200",children:[W.jsxs("header",{className:"text-center mb-12",children:[W.jsx("img",{src:"https://placehold.co/150x150/6366F1/FFFFFF?text=LOGO",alt:"Logo",className:"w-36 h-36 object-contain mx-auto mb-6 rounded-full shadow-lg border-4 border-indigo-300"}),W.jsx("h1",{className:"text-5xl font-extrabold text-gray-900 tracking-tight leading-tight animate-fade-in-down",children:"Sistemas Varella"}),W.jsx("p",{className:"text-xl text-gray-600 mt-3 animate-fade-in",children:"Gerenciamento de Acessos Moderno"})]}),W.jsx("main",{children:(()=>{var t;const n=(e=>{var t;return(null==(t=g.find((t=>t.email===e)))?void 0:t.role)||"Guest"})(l),r=(e=>{var t;return(null==(t=g.find((t=>t.email===e)))?void 0:t.name)||"Unknown"})(l),s=(e=>{var t;return(null==(t=g.find((t=>t.email===e)))?void 0:t.active)||!1})(l);if(!a||v)return W.jsxs("div",{className:"flex flex-col items-center justify-center h-64 text-gray-700",children:[W.jsx("div",{className:"animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-blue-500"}),W.jsx("p",{className:"mt-4 text-lg",children:"A carregar dados..."})]});if(b)return W.jsxs("div",{className:"text-center p-6 bg-red-100 text-red-700 rounded-lg shadow-md max-w-lg mx-auto",children:[W.jsx("p",{className:"font-bold text-xl mb-2",children:"Erro:"}),W.jsx("p",{children:b}),W.jsx("button",{onClick:()=>window.location.reload(),className:"mt-4 bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition duration-200",children:"Recarregar Página"})]});switch(c){case"welcome":return W.jsxs("div",{className:"text-center p-8 bg-white rounded-xl shadow-2xl max-w-lg mx-auto flex flex-col items-center justify-center border border-gray-100 transform transition-all duration-500 ease-in-out scale-100 hover:scale-105",children:[W.jsxs("h1",{className:"text-4xl font-extrabold text-gray-900 mb-4 animate-fade-in-down",children:["Bem-vindo, ",r,"!"]}),W.jsxs("p",{className:"text-xl text-gray-700 mb-8 animate-fade-in",children:["Sua função: ",W.jsx("span",{className:"font-bold text-indigo-600",children:n})]}),s?W.jsxs("div",{className:"flex flex-col sm:flex-row justify-center gap-6 w-full px-4",children:["Admin"===n&&W.jsx("button",{onClick:()=>h("admin"),className:"flex items-center justify-center gap-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-indigo-300 font-semibold text-lg w-full sm:w-auto",children:"🛡️ Painel Admin"}),W.jsx("button",{onClick:()=>h("apps"),className:"flex items-center justify-center gap-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-emerald-300 font-semibold text-lg w-full sm:w-auto",children:"📱 Ver Aplicativos"})]}):W.jsx("p",{className:"text-red-600 text-2xl font-bold mt-6 animate-pulse",children:"Usuário inativo. Entre em contato com o administrador."}),W.jsxs("div",{className:"mt-10 w-full px-4",children:[W.jsx("label",{htmlFor:"user-select",className:"block text-gray-800 text-base font-bold mb-3",children:"Simular Login como:"}),W.jsx("select",{id:"user-select",value:l,onChange:e=>u(e.target.value),className:"shadow-inner appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200 bg-gray-50",children:g.map((e=>W.jsxs("option",{value:e.email,children:[e.name," (",e.role,")"]},e.id)))})]}),i&&W.jsxs("p",{className:"mt-6 text-sm text-gray-500",children:["ID do Usuário Logado: ",W.jsx("span",{className:"font-mono text-gray-700 break-all bg-gray-100 p-2 rounded-md",children:i})]})]});case"apps":const a=(null==(t=g.find((e=>e.email===l)))?void 0:t.accessibleApps)||[],o=E.filter((e=>a.includes(e.name)));return W.jsxs("div",{className:"p-8 bg-white rounded-xl shadow-2xl max-w-5xl mx-auto text-center border border-gray-100 transform transition-all duration-500 ease-in-out scale-100 hover:scale-105",children:[W.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-8 flex items-center justify-center gap-3 animate-fade-in-down",children:"📱 Seus Aplicativos"}),o.length>0?W.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10",children:o.map((e=>W.jsxs("a",{href:e.url,target:"_blank",rel:"noopener noreferrer",className:"flex flex-col items-center justify-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl shadow-md hover:shadow-lg transform hover:scale-105 transition duration-300 ease-in-out text-purple-800 font-semibold text-lg text-center border border-purple-200 group",children:[W.jsx("span",{className:"text-4xl mb-3 group-hover:animate-bounce",children:"🔗"}),e.name]},e.name)))}):W.jsx("p",{className:"text-xl text-gray-600 mb-10",children:"Nenhum aplicativo acessível. Contacte o administrador."}),W.jsx("button",{onClick:()=>h("welcome"),className:"flex items-center justify-center gap-3 bg-gray-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-gray-300 font-semibold text-lg mx-auto",children:"🏠 Voltar ao Início"})]});case"admin":return W.jsxs("div",{className:"p-8 bg-white rounded-xl shadow-2xl max-w-xl mx-auto text-center border border-gray-100 transform transition-all duration-500 ease-in-out scale-100 hover:scale-105",children:[W.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-8 flex items-center justify-center gap-3 animate-fade-in-down",children:"🛡️ Painel Administrativo"}),W.jsxs("div",{className:"flex flex-col sm:flex-row justify-center gap-6 mb-10",children:[W.jsx("button",{onClick:()=>h("admin-users"),className:"flex items-center justify-center gap-3 bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-blue-300 font-semibold text-lg",children:"👤 Gerenciar Usuários"}),W.jsx("button",{onClick:()=>{f(null),m({name:"",email:"",role:"User",active:!0,accessibleApps:[]}),h("admin-add-user")},className:"flex items-center justify-center gap-3 bg-gradient-to-r from-purple-500 to-pink-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-purple-300 font-semibold text-lg",children:"➕ Adicionar Novo Usuário"})]}),W.jsx("button",{onClick:()=>h("welcome"),className:"flex items-center justify-center gap-3 bg-gray-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-gray-300 font-semibold text-lg mx-auto",children:"🏠 Voltar ao Início"})]});case"admin-users":return W.jsxs("div",{className:"p-8 bg-white rounded-xl shadow-2xl max-w-6xl mx-auto text-center border border-gray-100 transform transition-all duration-500 ease-in-out scale-100 hover:scale-105",children:[W.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-8 flex items-center justify-center gap-3 animate-fade-in-down",children:"👤 Cadastro e Gerenciamento de Usuários"}),W.jsx("div",{className:"overflow-x-auto mb-10 rounded-lg border border-gray-200 shadow-md",children:W.jsxs("table",{className:"min-w-full bg-white",children:[W.jsx("thead",{className:"bg-gradient-to-r from-gray-100 to-gray-200 border-b border-gray-300",children:W.jsxs("tr",{children:[W.jsx("th",{className:"py-4 px-6 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider",children:"Nome"}),W.jsx("th",{className:"py-4 px-6 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider",children:"Email"}),W.jsx("th",{className:"py-4 px-6 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider",children:"Função"}),W.jsx("th",{className:"py-4 px-6 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider",children:"Ativo"}),W.jsx("th",{className:"py-4 px-6 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider",children:"Ações"})]})}),W.jsx("tbody",{children:g.map((e=>W.jsxs("tr",{className:"border-b border-gray-100 hover:bg-blue-50 transition duration-150",children:[W.jsx("td",{className:"py-4 px-6 text-gray-800 font-medium",children:e.name}),W.jsx("td",{className:"py-4 px-6 text-gray-700 text-sm",children:e.email}),W.jsx("td",{className:"py-4 px-6 text-gray-700",children:e.role}),W.jsx("td",{className:"py-4 px-6 text-gray-800",children:e.active?W.jsx("span",{className:"inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 shadow-sm",children:"✅ Sim"}):W.jsx("span",{className:"inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-100 text-red-800 shadow-sm",children:"❌ Não"})}),W.jsx("td",{className:"py-4 px-6",children:W.jsxs("div",{className:"flex gap-3",children:[W.jsx("button",{onClick:()=>{f(e),h("admin-edit-user")},className:"p-3 rounded-full bg-yellow-100 text-yellow-700 hover:bg-yellow-200 transition duration-200 shadow-sm hover:shadow-md",title:"Editar Usuário",children:"✏️"}),W.jsx("button",{onClick:()=>S(e.id),className:"p-3 rounded-full bg-red-100 text-red-700 hover:bg-red-200 transition duration-200 shadow-sm hover:shadow-md",title:"Excluir Usuário",children:"🗑️"})]})})]},e.id)))})]})}),W.jsx("button",{onClick:()=>h("admin"),className:"flex items-center justify-center gap-3 bg-gray-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-gray-300 font-semibold text-lg mx-auto",children:"🏠 Voltar ao Painel Admin"})]});case"admin-add-user":case"admin-edit-user":const p="admin-edit-user"===c,y=p?d:{name:"",email:"",role:"User",active:!0,accessibleApps:[]},[v,b]=V.useState(y);V.useEffect((()=>{b(y)}),[c,d]);const k=e=>{const{name:t,value:n,type:r,checked:i}=e.target;b((e=>({...e,[t]:"checkbox"===r?i:n})))},T=e=>{b((t=>({...t,accessibleApps:t.accessibleApps.includes(e)?t.accessibleApps.filter((t=>t!==e)):[...t.accessibleApps,e]})))},C=t=>{t.preventDefault(),(async t=>{if(e){w(!0),_(null);try{const n=xS(IS(e,`artifacts/${wk}/public/data/users`),t.id||crypto.randomUUID());await pk(n,t,{merge:!0}),f(null),m({name:"",email:"",role:"User",active:!0,accessibleApps:[]}),h("admin-users")}catch(n){console.error("Erro ao salvar usuário no Firestore:",n),_("Erro ao salvar usuário. Verifique os dados e tente novamente.")}finally{w(!1)}}else _("Base de dados não inicializada.")})(v)};return W.jsxs("div",{className:"p-8 bg-white rounded-xl shadow-2xl max-w-xl mx-auto text-center border border-gray-100 transform transition-all duration-500 ease-in-out scale-100 hover:scale-105",children:[W.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-8 flex items-center justify-center gap-3 animate-fade-in-down",children:p?"✏️ Editar Usuário":"➕ Adicionar Novo Usuário"}),W.jsxs("form",{onSubmit:C,className:"space-y-6",children:[W.jsxs("div",{children:[W.jsx("label",{htmlFor:"name",className:"block text-gray-800 text-base font-bold mb-2",children:"Nome:"}),W.jsx("input",{type:"text",id:"name",name:"name",value:v.name,onChange:k,className:"shadow-inner appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200 bg-gray-50",required:!0})]}),W.jsxs("div",{children:[W.jsx("label",{htmlFor:"email",className:"block text-gray-800 text-base font-bold mb-2",children:"Email:"}),W.jsx("input",{type:"email",id:"email",name:"email",value:v.email,onChange:k,className:"shadow-inner appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200 bg-gray-50",required:!0})]}),W.jsxs("div",{children:[W.jsx("label",{htmlFor:"role",className:"block text-gray-800 text-base font-bold mb-2",children:"Função:"}),W.jsxs("select",{id:"role",name:"role",value:v.role,onChange:k,className:"shadow-inner appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-200 bg-gray-50",children:[W.jsx("option",{value:"Admin",children:"Admin"}),W.jsx("option",{value:"User",children:"User"}),W.jsx("option",{value:"Guest",children:"Guest"})]})]}),W.jsxs("div",{className:"flex items-center",children:[W.jsx("input",{type:"checkbox",id:"active",name:"active",checked:v.active,onChange:k,className:"mr-3 h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded-md cursor-pointer"}),W.jsx("label",{htmlFor:"active",className:"text-gray-800 text-base font-bold",children:"Ativo"})]}),W.jsxs("div",{children:[W.jsx("label",{className:"block text-gray-800 text-base font-bold mb-2",children:"Aplicativos Acessíveis:"}),W.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 gap-3 bg-gray-50 p-4 rounded-lg border border-gray-200",children:E.map((e=>W.jsxs("div",{className:"flex items-center",children:[W.jsx("input",{type:"checkbox",id:`app-${e.name}`,checked:v.accessibleApps.includes(e.name),onChange:()=>T(e.name),className:"mr-2 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded cursor-pointer"}),W.jsx("label",{htmlFor:`app-${e.name}`,className:"text-gray-700 text-sm font-medium",children:e.name})]},e.name)))})]}),W.jsxs("div",{className:"flex justify-end gap-4 mt-8",children:[W.jsx("button",{type:"button",onClick:()=>h("admin-users"),className:"flex items-center justify-center gap-2 bg-gray-500 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-gray-300 font-semibold text-lg",children:"Cancelar"}),W.jsx("button",{type:"submit",className:"flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-blue-300 font-semibold text-lg",children:p?"Atualizar Usuário":"Adicionar Usuário"})]})]})]});default:return W.jsx("div",{className:"text-center p-6 text-red-500",children:"404 - Vista não encontrada"})}})()})]})]})};Q.createRoot(document.getElementById("root")).render(W.jsx(j.StrictMode,{children:W.jsx(bk,{})}));
